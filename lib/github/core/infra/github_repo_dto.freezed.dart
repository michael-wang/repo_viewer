...
class _$GithubRepoDTOTearOff {
  ...
  _GithubRepoDTO call(
      ...
      @JsonKey(fromJson: nullableJsonString) required String description,
...
mixin _$GithubRepoDTO {
  ...
  @JsonKey(fromJson: nullableJsonString)
...
abstract class $GithubRepoDTOCopyWith<$Res> {
  ...
  $Res call(
      {UserDTO owner,
      String name,
      @JsonKey(fromJson: nullableJsonString) String description,
...
class _$_GithubRepoDTO extends _GithubRepoDTO {
  const _$_GithubRepoDTO(
      {required this.owner,
      required this.name,
      @JsonKey(fromJson: nullableJsonString) required this.description,
